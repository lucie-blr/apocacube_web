...
const config = {
    serverInfo: {
        ...
        serverName: "Apocacube", /*Server name*/
        serverIp: "89.213.131.18", /*Server IP (if you want to add online user counter, you must have true the enable-status and enable-query of server.properties)*/
        discordServerID: "1197270192024207420" /*Your server ID (if you want to add online user counter, you must have enabled Discord server widget)*/
    },
...
/*Change the function to add the possibility to put custom images, especially for the companions */
